...
namespace gcp
{
   ...
   {
   public:
      virtual void Draw_Line(const GCP_Point<int> &A, const GCP_Point<int> &B, const GCP_Color &color, short bold) const = 0;
...
#define DECL_GCP_DRAW_BASE\
         void Draw_Line(const GCP_Point<int> &A, const GCP_Point<int> &B, const GCP_Color &color, short bold) const;\
